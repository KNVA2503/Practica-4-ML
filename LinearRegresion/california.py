...
# 1. Cargar el dataset de precios de casas
print("Cargando el dataset de California Housing...")
housing = fetch_california_housing()
print("Dataset cargado exitosamente.")

# 2. Preparar los datos para el modelo
# La variable 'y' es el precio. 'X' son todas las demás columnas.
X = housing.data
y = housing.target
...
plt.xlabel("Valores Reales (Precios en $100,000)")
plt.ylabel("Valores Predichos (Precios en $100,000)")
